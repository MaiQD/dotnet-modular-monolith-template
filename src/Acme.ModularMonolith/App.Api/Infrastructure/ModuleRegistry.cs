...
public static class ModuleRegistry
{
    ...
    private static void RegisterModule(IServiceCollection services, IConfiguration configuration, string moduleName)
    {
        try
        {
            ...
            var applicationAssemblyName = $"App.Modules.{moduleName}.Application";
            ...
            var infrastructureAssemblyName = $"App.Modules.{moduleName}.Infrastructure";
            ...
            var registrationTypeName = $"App.Modules.{moduleName}.Application.Configuration.{moduleName}ModuleRegistration";
    ...
    private static async Task SeedModuleData(IServiceProvider services, string moduleName)
    {
        try
        {
            ...
            if (File.Exists(infrastructureAssemblyPath))
            {
                ...
                var seederTypeName = $"App.Modules.{moduleName}.Infrastructure.Configuration.{moduleName}InfrastructureModule";
