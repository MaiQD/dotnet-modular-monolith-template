...
namespace App.Modules.Users.Application.Configuration;
    ...
    public static IServiceCollection AddUsersModule(this IServiceCollection services, IConfiguration configuration)
    {
        try
        {
            ...
            if (infrastructureAssembly == null)
            {
                ...
                infrastructureAssembly = System.Reflection.Assembly.Load("App.Modules.Users.Infrastructure");
            }
            
            var moduleType = infrastructureAssembly.GetType("App.Modules.Users.Infrastructure.Configuration.UsersInfrastructureModule");
